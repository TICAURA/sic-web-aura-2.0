...
/**
 * <p>Clase Java para confirmaAbonoIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="confirmaAbonoIdResponse">
 *   &lt;complexContent>
...
@XmlType(name = "confirmaAbonoIdResponse", propOrder = {
    "_return"
})
public class ConfirmaAbonoIdResponse {
