...
/**
 * <p>Clase Java para devuelveOrdenClaveRastreoResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="devuelveOrdenClaveRastreoResponse">
 *   &lt;complexContent>
...
@XmlType(name = "devuelveOrdenClaveRastreoResponse", propOrder = {
    "_return"
})
public class DevuelveOrdenClaveRastreoResponse {
