...
/**
 * <p>Clase Java para confirmaCargoResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="confirmaCargoResponse">
 *   &lt;complexContent>
...
@XmlType(name = "confirmaCargoResponse", propOrder = {
    "_return"
})
public class ConfirmaCargoResponse {
