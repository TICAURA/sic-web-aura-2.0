...
/**
 * <p>Clase Java para confirmaCargoRastreoResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="confirmaCargoRastreoResponse">
 *   &lt;complexContent>
...
@XmlType(name = "confirmaCargoRastreoResponse", propOrder = {
    "_return"
})
public class ConfirmaCargoRastreoResponse {
