...
public class ColaboradorDto implements Serializable {
    ...
    private List<DocumentoCSMDto> documentos;
    ...
    private List<BeneficioAdicionalColaboradorDto> listBeneficioAdicColab;

    public ColaboradorDto() {
    }

    public ColaboradorDto(Long idColaborador) {
        this.idColaborador = idColaborador;
    }

    public ColaboradorDto(Long idColaborador, String claveTrabajador, String nombre, String apellidoPaterno, Date fechaNacimiento, String rfc, String curp, Long usuarioAlta, Date fechaAlta, String indEstatus) {
        this.idColaborador = idColaborador;
	...
	public List<DocumentoCSMDto> getDocumentos() {
		return documentos;
	}

	public void setDocumentos(List<DocumentoCSMDto> documentos) {
    ...
    public List<BeneficioAdicionalColaboradorDto> getListBeneficioAdicColab() {
		return listBeneficioAdicColab;
	}

	public void setListBeneficioAdicColab(List<BeneficioAdicionalColaboradorDto> listBeneficioAdicColab) {
		this.listBeneficioAdicColab = listBeneficioAdicColab;
	}
