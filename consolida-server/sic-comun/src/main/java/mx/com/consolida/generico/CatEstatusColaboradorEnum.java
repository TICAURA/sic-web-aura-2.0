...
public enum CatEstatusColaboradorEnum {
	...
	EDITAR_TIMBRE(16L,"EDICION TIMBRE","COLABORADOR EDITADO TIMBRE","CARGADO"),
	TRASPASO_LIQUIDADO_STP(20L,"LIQ_STP","LIQUIDADA STP","TLQ"),
	TRASPASO_CANCELADO_STP(21L,"LIQ_STP","LIQUIDADA STP","TCL");
