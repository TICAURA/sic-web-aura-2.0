...
public class CanalVentaController extends  BaseController {
	@Autowired
	...
	public List<CanalVentaDto> canalesVenta(Model model){
	...
	@RequestMapping(value = "/canalVenta", method = RequestMethod.GET)
	public Map<String , Object> canalVenta(Model model){
		Map<String, Object> catalogosIniciales = new HashedMap();
	...
	@RequestMapping(value = "/oficinaCanalVenta", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/oficinasCanalVenta", method = RequestMethod.GET)
	public List<OficinaDto> oficinasCanalVenta(Model model){
		return canalVentaBO.listarTodasOficinas();
	}
