angular.module('theme.demos.tasks', [])
  .controller('TasksController', ['$scope', function($scope) {
    ...
    $scope.tasks = [{
      title: 'Servidor principal sin conexion en los datos con la informacion de datos construccion de los datos con la informacion de datos con la configuracion de medios de datos',
      label: 'Due tomorrow',
      color: 'success'
    }, {
      title: 'Compile Code',
