...
angular.module('theme.core.templates')
        .controller('comisionistaController', function ($scope, $location, $timeout, $http, CONFIG, $bootbox, $log, pinesNotifications, agregarPrestadoraServicioService) {
	  ...
	  $scope.cargaInicial = function(){
		  ...
		  $http.get(CONFIG.APIURL + "/comisiones/canalVenta.json").then(
					function(data) {
