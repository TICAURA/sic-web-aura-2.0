...
angular.module('theme.core.templates')
  .controller('autorizaTesoreriaController', function( $route,$window,$scope, $rootScope, $templateCache,$location, $timeout,$http, CONFIG, $bootbox,$log, autorizaTesoreriaService, nominaService, pinesNotifications) {
	  ...
	  $scope.cargaInicial = function(){
		  ...
		  autorizaTesoreriaService.cargaInicialTesoreriaNominaParaAutorizarFinanciamiento(function(response) {
	      ...
	      $scope.cargaInicialColaboradores = function (idNominaCliente) {
		    ...
		    $scope.modalAutorizarFinanciamiento = function (idPppNomina) {
		 	  ...
		 	  $scope.autorizarFinanciamiento = function(idPppNomina) {
				  ...
				  autorizaTesoreriaService.autorizarFinanciamientoTesoreria($scope.nominaDto,function(response) {
			  ...
			  $scope.modalRechazarFinanciamiento = function (idPppNomina) {
		       ...
		       $scope.rechazarFinanciamiento = function (idPppNomina){
					...
					autorizaTesoreriaService.rechazarFinanciamientoTesoreria($scope.nominaDto,function(response) {
								 		if(response.data.mensajeError != undefined || response.data.mensajeError != null){
