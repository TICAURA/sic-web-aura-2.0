...
angular.module('theme.core.templates')
  .controller('registroGrupoTrabajoController',  function($scope, $location, $timeout,$http, CONFIG, $bootbox,$log) {
...
//									});
    ...
    $scope.cancelar = function() {
    	location.href=CONFIG.APIURL+"#/crm/grupoTrabajo/consultaPersonal";
    }
