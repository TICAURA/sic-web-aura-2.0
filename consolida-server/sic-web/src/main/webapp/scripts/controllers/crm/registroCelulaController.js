...
angular.module('theme.core.templates')
  .controller('registroCelulaController',  function($scope, $location, $timeout,$http, CONFIG, $bootbox,$log, registroCelulaService) {
...
//										location.href=APIURL+"#/crm/clientes";
    ...
    $scope.cancelar = function() {
    	location.href=CONFIG.APIURL+"#/crm/celula/consultaCelula";
    }
